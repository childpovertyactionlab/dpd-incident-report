...
## `r paste(month(thismonth, label = TRUE, abbr = FALSE), thisyear)` Summary
...
In the last month there were a total of `r paste0(ArYes$count)` arrests for Violent Gun Crimes across the City of Dallas, which was `r paste0(round(ArYes$count/sum(ArVGC$count), digits = 3)*100, "%")` of all Violent Gun Crime incidents.
